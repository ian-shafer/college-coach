...
public class KeychainSessionAdapter: SessionManager {
    ...
    public func createSession() -> AuthSession {
    ...
    public func setToken(_ session: AuthSession, token: String) -> AuthSession {
    ...
    public func logout(_ session: AuthSession) -> AuthSession {
        let query: [String: Any] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrAccount as String: tokenKey
        ]
